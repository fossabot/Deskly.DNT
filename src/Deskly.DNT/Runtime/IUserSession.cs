...
namespace Deskly.DNT.Runtime
{
    ...
    public interface IUserSession : IScopedDependency
    {
        ...
        /// <summary>
        /// Gets current UserName or null. It can be null if no user logged in.
        /// </summary>
        string UserName { get; }
        ...
        /// <summary>
        /// Gets current user's Roles. It can be null if no user logged in.
        /// </summary>
        IReadOnlyList<string> Roles { get; }

        /// <summary>
        /// Gets current user's Claims. It can be null if no user logged in.
        /// </summary>
        IReadOnlyList<Claim> Claims { get; }

        /// <summary>
        /// Gets current UserDisplayName or null. It can be null if no user logged in.
        /// </summary>
        string UserDisplayName { get; }

        /// <summary>
        /// Gets current UserBrowserInfo or null. It can be null if no user logged in.
        /// </summary>
        string UserBrowserName { get; }

        /// <summary>
        ///  Gets current UserIP or null. It can be null if no user logged in.
        /// </summary>
        string UserIP { get; }
